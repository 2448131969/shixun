...
public class jobs3 {
    public static void main(String[] args) throws IOException {
        File file = new File("C:\\Users\\LC\\Desktop\\课程设计\\任务\\任务\\zpsjj\\jobs3.csv");
        InputStream in = new FileInputStream(file);
        OutputStream out = new FileOutputStream("C:\\Users\\LC\\Desktop\\课程设计\\zpsjj\\jobs3.txt");//输出成txt文件
