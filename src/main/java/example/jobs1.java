...
public class jobs1 {
    public static void main(String[] args) throws IOException {
        File file = new File("C:\\Users\\LC\\Desktop\\课程设计\\任务\\任务\\zpsjj\\jobs1.csv");
        InputStream in = new FileInputStream(file);
        OutputStream out = new FileOutputStream("C:\\Users\\LC\\Desktop\\课程设计\\zpsjj\\jobs1.txt");//输出成txt文件
